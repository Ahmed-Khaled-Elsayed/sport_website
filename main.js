function verifyPassword() {
  ...
  // special char
  if (pw.search(/[!\@\#\$\%\^\&\*\(\)\_\+\-\=\<\>\?\,]/) == -1) {
    document.getElementById("message").innerHTML = "**password should contain atleast one special character";
    return false;
  }
  // one digit
  if (pw.search(/[0-9]/) == -1) {
    document.getElementById("message").innerHTML = "**password should contain atleast one digit";
    return false;
  }
  // white spaces
  if (pw.search(/[ ]/) != -1) {
